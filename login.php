...
<body>
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form method="POST" autocomplete="off" class="col s12">
                ...
                <button name="studentLogin">Sign Up</button>
            </form>
        </div>
        <div class="form-container log-in-container">
            <form method="POST" autocomplete="off" class="col s12">
                ...
                <a class="link" href="alogin.php" style="color: black;">or Admin login</a>

                <button name="studentLogin">Log in</button>
            </form>
        </div>
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    <h1>Welcome Kiitians!</h1>
                    <p>To keep connected with us please Login with your personal info</p>
                    <button class="ghost" id="login">Login </button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Hello, Hosteler's!</h1>
                    <p>Enter your personal details and start journey with us</p>
                    <img src="assets/imgs/download.jpg" alt="Start Journey Image">
                </div>
    ...
    <footer>
        <p>
            Welcome to KIIT HOSTEL MANAGEMENT SYSTEM
            <a href='https://kiit.ac.in/ ' for more information></a>
        </p>
    </footer>
